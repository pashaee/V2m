...
fun MainTopBar(
    ...
    AppTopBar(
        // تغییر 4: عنوان به Menu تغییر یافت
        title = "Menu",
        onBackClick = {},
        isLoading = isLoading,
        isSearchActive = false, // جستجو کلا غیرفعال شد
        searchQuery = "",
        onSearchQueryChange = {},
        onSearchClose = {},
        searchPlaceholder = "",
        navigationIcon = {
            // آیکون منوی همبرگری ثابت شد
            IconButton(onClick = onMenuClick) {
                Icon(painterResource(R.drawable.ic_menu_24dp), contentDescription = stringResource(R.string.acc_open_menu))
            }
        },
        actions = {
            // تغییر 1 و 2: آیکون‌های جستجو و سه‌نقطه کاملاً حذف شدند

            Box(modifier = Modifier.wrapContentSize(Alignment.TopEnd)) {
                // فقط دکمه + (اضافه کردن کانفیگ) باقی ماند
